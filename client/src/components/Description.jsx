        ...
        <div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
            ...
            <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
                ...
                <div>
                    ...
                    <p className='text-gray-600 '>Simply type in a prompt, and our cutting-edge AI will generate high-quality images in seconds. From product visuals to character designs and potraits, even concepts that don't yet exist can be visualized effortlessly. Powered by advanced AI technology, the creative possibilities are limitless.</p>
                </div>
            </div>
        </div>
    )
